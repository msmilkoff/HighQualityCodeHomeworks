...
class Program
{
    ...
    class EventHolder
    {
        var byTitle = new MultiDictionary<string, Event>(true);
        var byDate = new OrderedBag<Event>();
        ...
        {
            OrderedBag<Event>.VieweventsToShow = byDate
        ...
        out string eventLocation)
    {
        ...
        {
             commandString = commandForExecution.Substring(firstPipeIndex + 1).Trim();

            eventTitle = commandString;
            eventLocation = "";
        }
        else
        {
            int startIndex = firstPipeIndex + 1;
            int legth = lastPipeIndex - firstPipeIndex - 1;

            eventTitle = commandForExecution.Substring(startIndex, legth).Trim();
    ...
    {
        string dateString = command.Substring(commandType.Length + 1, 20);
